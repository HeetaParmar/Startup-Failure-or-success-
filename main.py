...
### streamlit run C:\Users\DELL\OneDrive\Desktop\PDA_GUI\main.py
...
st.image(r"C:\Users\DELL\OneDrive\Desktop\PDA_GUI\Startup_Fail_Success.png")

raw_data = r"C:\\Users\\DELL\\OneDrive\\Desktop\\PDA_GUI\\Startup_dataset.csv"

clean_data = r"C:\\Users\\DELL\\OneDrive\\Desktop\\PDA_GUI\\df_cleaned.csv"
...
with st.expander("Description of Data Wrangling done on dataset:"):
    ...
    st.image(r"C:\Users\DELL\OneDrive\Desktop\PDA_GUI\funding_rounds_group.png")
    ...
    st.write(df['funding_filled'].isnull().sum())
    ...
    st.dataframe(df[['country','year','first_funding_at']].sample(5))
